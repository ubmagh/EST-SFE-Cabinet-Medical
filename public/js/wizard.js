            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (resp.status == "Good") {
                        ...
                        $('#steps-uid-0-p-5').append(` <div class="row w-100 text-center my-3" > <a href="` + resp.certUrl + `" target="_blank" class="btn text-white btn-success text-center mx-auto"> <h3 class="h3"> <i class="fas fa-certificate"></i> Créer un Certificat </h3> </a> </div> `);
