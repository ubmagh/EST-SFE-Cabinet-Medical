...
@section('title')
Liste des consultation à domicile
@endsection
        ...
        <div class="d-block w-100 mb-n5 text-center mt-3">
            <a name="" id="" class="btn btn-primary mx-auto text-center text-white mb-n5 mt-3" role="button"
                data-toggle="modal" data-target="#AddModal" type="button"> <i class="fa fa-plus-circle fa-lg"
                    aria-hidden="true"></i> Ajouter une consultation à domicile </a>
        </div>
        <div class="row">
          <div class="col-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-0 text-center">
                          ...
                          data-toggle="modal" data-target="#modal_edit" class="btn btn-inverse-success btn-fw">
...
<div class="modal-dialog model-notify modal-md modal-right modal-info" role="document">
        ...
        <form id="addform">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class=" font-weight-bold " for="Type">Patient</label>
                    <input  name="Patient" id="patient" class="form-control" placeholder="Identification civile">
                </div>
            
                <div class="form-group">
                    <label class=" font-weight-bold " for="Type">Type de consultation</label>
                    <input value ="à Domicile" readonly name="Type" id="type" class="form-control">
                </div>
                ...
                <div class="form-group" >
                   ...
                   <textarea class="form-control" name="Description" id="description" rows="8" maxlength="450" placeholder="Description de la consultation"></textarea>
    ...
    rgba(198,233,229,1) 100%);" class="alert alert-success d-none">
                                        <i class="fa fa-check"></i> <strong>Succés!</strong> La consultation est ajoutée avec
                                        succés !
                                    </div>
      ...
      rgba(235,204,221,0.927608543417367) 100%);" role="alert" class="alert alert-danger d-none">
                                        <i class="fa fa-times"></i> <strong>Danger !</strong> La consultation n'est pas
                                        ajoutée !
                                    </div>
...
<script>
    ...
    document.getElementById('addform').onsubmit =
        function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/ListeConsultationAdomicile/add",
