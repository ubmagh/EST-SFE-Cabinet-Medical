...
@section('content')
    ...
    <div class="content-wrapper">
        <form action="{{ url('ADomicile') }}" enctype="multipart/form-data" id="DomForm" methode="POST">
                ...
                <div class="card-body d-none ContentSec">
                    ...
                    <div class="row w-100 mx-auto mb-4 " id="finishState">
                        <div class="col-md-8 mx-auto">
                            ...
                            <div class="w-100 mx-auto d-none" id="PatientDetails">
                                <div class="card rounded border mb-2">
                                    <div class="card-body p-3">
                                        <div class="media">
                                            ...
                                            <a href="#" target="_blank" id="dossier" class="float-right mr-4"> <i class="far fa-id-card fa-lg"></i></a>
            ...
            <div class="card con d-none my-4">
                <div class="card-body">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control" name="Description" id="Titre" maxlength="200" required rows="2"></textarea>
                        <div class="alert alert-danger alert-dismissible fade mt-n5 d-none " role="alert"
                                        id="DescriptionAlert">
                    ...
                    <div class="form-group" >
                        <div class="form-check d-block mx-auto">
                          <label class="form-check-label text-danger">
                            <input type="checkbox" class="form-check-input" name="Urgent" id="" value="checkedValue" >
