                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$patient['DateNaissance']}}</td>
                        ...
                        role="button" type="button" class="btn btn-outline-info py-2 ">
                        ...
                        data-toggle="modal" data-target="#modal_edit"   role="button" type="button" 
                          ...
                          <!-- -------------------- DELETE BUTTON   ------------------------- -->
                        <button data-id_delete="{{ $patient['id'] }}"  data-toggle="modal" data-target="#ModalDelete" 
...
<div class="modal fade left" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog model-notify modal-md modal-right modal-info" role="document">
    <div class="modal-content">
      ...
      <form id="addform" action="####here" method="POST"> 
        ...
        <div class="form-group">
          ...
          <input name="id_civile" type="text" class="form-control" placeholder="Entrer le numéro d'identité">
        </div>
        ...
        <div class="form-group">
          ...
          <input name="Tel" type="tel" class="form-control"  placeholder="Entrer le numéro de téléphone">
        </div>
        ...
        <div class="form-group">
          ...
          <input name="Ville" type="text" class="form-control" placeholder="Entrer la ville">
        </div>

        <div class="form-group">
          <label for="exampleFormControlInput1">Ocuupation</label>
          <input name="Occupation" type="text" class="form-control" placeholder="Entrer l'occupation">
        </div>

        <div class="form-group">
          <label for="exampleFormControlInput1">Nationalité</label>
          <input name="Nationnalite" type="text" class="form-control" placeholder="Entrer la nationalité">
        </div>
        ...
        <div class="form-group">
          ...
          <input name="ref_mutuel" type="text" class="form-control" placeholder="Entrer la référence de la mutuelle">
        </div>
    ...
    rgba(198,233,229,1) 100%);" class="alert alert-success d-none">
        <i class="fa fa-check"></i> <strong>Succés!</strong> Le patient est ajouté avec succés ! 
      </div>
      ...
      rgba(235,204,221,0.927608543417367) 100%);" role="alert" class="alert alert-danger d-none">
          <i class="fa fa-times"></i> <strong>Danger !</strong> Le patient n'est pas ajouté ! 
        </div>
...
<div class="modal fade left" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog model-notify modal-md modal-right modal-info" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form  id="editform"> 
        ...
        <div class="form-group">
          ...
          <input name="Nom" id="nom_edit" type="text"  class="form-control" placeholder="Entrer le nom">
        </div>

        <div class="form-group">
          <label for="prenom">Prénom</label>
          <input name="Prenom" id="prenom_edit" type="text" class="form-control" placeholder="Entrer le prénom">
        </div>
        ...
        <div class="form-group">
          <label for="datenaissance">Date de naissance</label>
          <input name="DateNaissance" id="datenaissance_edit" type="date" class="form-control">
        </div>


        <div class="form-group">
          <label for="id_civile">Numéro d'identité</label>
          <input name="id_civile" id="id_civile_edit" type="text" class="form-control" placeholder="Entrer le numéro d'identité">
        </div>


        <div class="form-group">
          <label for="email">Email</label>
          <input name="Email" id="email_edit" type="email" class="form-control"  placeholder="name@example.com">
        </div>

        <div class="form-group">
          <label for="tel">Téléphone</label>
          <input name="Tel" id="tel_edit" type="tel" class="form-control"  placeholder="Entrer le numéro de téléphone">
        </div>
        ...
        <div class="form-group">
          ...
          <input name="adresse" id="adresse_edit" type="text" class="form-control" placeholder="Entrer l'adresse">
        </div>

        <div class="form-group">
          <label for="ville">Ville</label>
          <input name="Ville"  id="ville_edit" type="text" class="form-control" placeholder="Entrer la ville">
        </div>

        <div class="form-group">
          <label for="occupation">Occupation</label>
          <input name="Occupation" id="occupation_edit" type="text" class="form-control" placeholder="Entrer l'occupation">
        </div>

        <div class="form-group">
          <label for="nationnalite">Nationalité</label>
          <input name="Nationnalite" id="nationnalite_edit" type="text" class="form-control" placeholder="Entrer la nationalité">
        </div>
        ...
        <div class="form-group">
          ...
          <input name="ref_mutuel" id="refmutuel_edit" type="text" class="form-control" placeholder="Entrer la référence de la mutuelle">
        </div>
    ...
    rgba(198,233,229,1) 100%);" class="alert alert-success d-none">
        <i class="fa fa-check"></i> <strong>Succés!</strong> Le patient est modifié avec succés ! 
      </div>

      <div id="msgDanger-edit" style="background: rgb(235,204,209);background: linear-gradient(0deg, rgba(235,204,209,1) 0%, 
      rgba(235,204,221,0.927608543417367) 100%);" role="alert" class="alert alert-danger d-none">
          <i class="fa fa-times"></i> <strong>Danger !</strong> Le patient n'est pas été modifié ! 
        </div>
...
<div class="modal fade left" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog model-notify modal-md modal-right modal-info" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form id="deleteform"> 
        ...
        <p class="text-center" style="font-size : 20px" >Voulez-vous vraiment supprimer ce patient ?</p><br>



          <button type="button" class="btn btn-primary" data-dismiss="modal" style="margin-left : 12%"><i class="far fa-times-circle"></i> Non/Annuler</button>
        <button type="submit" class="btn btn-danger" style="margin-left : 12%"><i class="fas fa-trash-alt"></i> Oui/Supprimer</button>
        </div>
    </form>

    <div id="msgSucc-delete" role="alert" style="background: rgb(214,233,198);background: linear-gradient(0deg, rgba(214,233,198,1) 0%, 
    rgba(198,233,229,1) 100%);" class="alert alert-success d-none">
        <i class="fa fa-check"></i> <strong>Succés!</strong> Le patient est supprimé avec succés ! 
      </div>

      <div id="msgDanger-delete" style="background: rgb(235,204,209);background: linear-gradient(0deg, rgba(235,204,209,1) 0%, 
      rgba(235,204,221,0.927608543417367) 100%);" role="alert" class="alert alert-danger d-none">
          <i class="fa fa-times"></i> <strong>Danger !</strong> Le patient n'est pas été supprimé ! 
        </div>
...
<div class="modal fade left" id="ShowModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog model-notify modal-md modal-right modal-info" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form  id="editform"> 
        ...
        <div class="form-group">
          <label for="adresse">Adresse</label>
          <input name="adresse" id="adresse_show" type="text" class="form-control" readonly> 
        </div>
        ...
        <div class="form-group">
          <label for="occupation">Occupation</label>
          <input name="Occupation" id="occupation_show" type="text" class="form-control" readonly>
        </div>

        <div class="form-group">
          <label for="nationnalite">Nationalité</label>
          <input name="Nationnalite" id="nationnalite_show" type="text" class="form-control" readonly> 
        </div>

        <div class="form-group">
          <label for="nationnalite">Mutuelle</label>
          <input name="Nationnalite" id="typemutuel_show" type="text" class="form-control" readonly>
        </div>


        <div class="form-group">
          <label for="ref_mutuel">Référence de la mutuelle</label>
          <input name="ref_mutuel" id="refmutuel_show" type="text" class="form-control" readonly>
        </div>
