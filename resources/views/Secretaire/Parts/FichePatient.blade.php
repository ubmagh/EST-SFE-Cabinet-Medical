        ...
        <div class="card-body py-4">
            ...
            <div class="row w-100 my-5 p-4" >      
                ...
                <div class="col-md col-12 text-center">
                    <a class="btn btn-info text-white text-center" href="{{ url('Paiement',$patient->id) }}" target="_blank" >
                ...
                <div class="col-md col-12 text-center">
                    <a class="btn btn-warning text-white text-center" href="{{ url('Rendez-Vous') }}" target="_blank" >
