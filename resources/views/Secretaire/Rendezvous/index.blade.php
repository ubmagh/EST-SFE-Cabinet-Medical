...
{{-- hado zthom ela wd calendar --}}
{{-- had cdn mzl madrthom sous forme des fichiers --}}
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          eventDrop : function(info){ // had fonction ela wd update dial chi rdv
            ...
            let true_date = info.event.start.getFullYear() + '-' + (info.event.start.getMonth()+1) + '-' +info.event.start.getDate();
            let true_heure = info.event.start.getHours() + ':' + info.event.start.getMinutes() + ":" + info.event.start.getSeconds();                                    
            let Token =  $('meta[name="csrf-token"]').attr('content')+"";
            //console.log(token);
