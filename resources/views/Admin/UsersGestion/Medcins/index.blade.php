                                ...
                                <tbody>
                                    @foreach($medcins as $medcin)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $medcin['Nom'].' '.$medcin['Prenom'] }}
                                            </td>
                                            <td class="text-center">{{ $medcin['Email'] }}
                                            </td>
                                            <td class="text-center">{{ $medcin['Tel'] }}
                                            </td>
                                            <td class="text-center">
                                                {{ substr($medcin['created_at'],0,16) }}
                                            </td>
                                            <td class="px-0 text-center">
                                                <button class="btn btn-outline-secondary py-2 " role="button"
                                                    ...
                                                    data-id="{{ $medcin['id'] }}"
                                                    data-Nom="{{ $medcin['Nom'] }}"
                                                    data-Prenom="{{ $medcin['Prenom'] }}"
                                                    data-Pseudo="{{ $medcin['Pseudo'] }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST"  id="createForm">
                    ...
                    <div class="form-group mb-2">
                        <label for="Specialites">Specialité(s) : </label>
                        <input name="Specialite" id="Specialite" type="text"  maxlength="30" 
                            class="form-control" placeholder="">
                    </div>
                    <div class="alert alert-danger alert-dismissible fade mt-n5 d-none " role="alert"
                        id="Create_SpecialiteModal">
                        <span id="CreateSpecialiteError"></span>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="EditForm">
                    ...
                    <div class="form-group mb-2">
                        <label for="SpecialitesEdit">Specialité(s) : </label>
                        <input name="Specialite" id="SpecialiteEdit" type="text"  maxlength="30" 
                            class="form-control" placeholder="">
                    </div>
                    <div class="alert alert-danger alert-dismissible fade mt-n5 d-none " role="alert"
                        id="Edit_SpecialiteModal">
                        <span id="EditSpecialiteError"></span>
                    </div>
...
$('#createForm').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: <?php echo '"'.url("users/medcins/create").'"'; ?>,
            data: $(this).serialize(),
            ...
            error: function (error) {
                ...
                if (error.responseJSON.errors) {
                    ...
                    if (errors.Specialite) {
                        $('#CreateSpecialiteError').html(error.responseJSON.errors.Specialite);
                        $('#Create_SpecialiteModal').removeClass('d-none').addClass('show');
                    }
                    if (errors.password) {
    ...
    $('#EditForm').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: <?php echo '"'.url('users/medcins/Modify').'"' ?>,
            data: $(this).serialize(),
            success: function (resp) {
                if (resp.status === "OK") {
                    $('#EditForm').hide();
            ...
            error: function (error) {
                ...
                if (error.responseJSON.errors) {
                    ...
                    if (response.errors.Specialite) {
                        $('#EditSpecialiteError').html(error.responseJSON.errors.Specialite);
                        $('#Edit_SpecialiteModal').removeClass('d-none').addClass('show');
                    }
...
$('#DELETEmodal').submit(function (e) {
        ...
        $.ajax({
            type: "DELETE",
            url: <?php echo '"'.url('users/medcins/Delete').'"' ?>,
            data: $(this).serialize(),
            success: function (resp) {
                if (resp.status === "OK") {
                    $('#DELETEmodal').hide();
