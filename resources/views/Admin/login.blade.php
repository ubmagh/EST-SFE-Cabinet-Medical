            ...
            <div class="col-lg-5 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <div class="row w-100 ml-1 mb-4 ">
                    ...
                    <div class="col-md-9 col-sm-12 d-block mx-auto">
                      <h1 class="h1 display-4 text-sm-center text-center mx-sm-auto mr-md-auto mt-sm-3 text-info"> Connexion Administrateur </h1>
                    </div>
                  </div>
                
              <form class="pt-3" method="POST" action="{{{ url('/admin') }}}">
                ...
                <div class="form-group">
                  ...
                  <a href="{{url('/')}}" class="btn btn-block btn-google auth-form-btn">
                      <i class="fa fa-arrow-left fa-lg" aria-hidden="true"></i>  Retourner à l'acceuil
                    </a>
                  </div>
                </form>
              </div>
